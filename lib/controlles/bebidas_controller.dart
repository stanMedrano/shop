...
class BebidasController {
  Future<List<Producto>> obtenerProductosBebidas() async {
    return await obtenerProductosPorCategoria('Bebidas');
  }

  void agregarProductoSeleccionado(ProductoSeleccionado producto,
  ...
  void quitarProductoSeleccionado(ProductoSeleccionado producto,
      List<ProductoSeleccionado> productosSeleccionados) {
    final productoExistente = productosSeleccionados.firstWhere(
      (item) => item.nombre == producto.nombre,
      orElse: () => ProductoSeleccionado(
